...
// MARK: - ImageTransformFeature Private Helper Method
...
private extension ImageTransformFeature {
    
    func prepareSquareForCoreML(image: UIImage, targetSize: CGFloat = 512) -> UIImage? {
    ...
    func cropToOriginalRatio(image: UIImage, originalRatio: CGFloat) -> UIImage? {
